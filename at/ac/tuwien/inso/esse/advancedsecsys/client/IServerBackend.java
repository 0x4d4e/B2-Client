...
public abstract interface IServerBackend
{
  ...
  public abstract Collection<Entry> queryForName(String paramString1, String paramString2)
    throws Exception;
}

/* Location:           secure-client-dex2jar.jar
 * Qualified Name:     at.ac.tuwien.inso.esse.advancedsecsys.client.IServerBackend
